...
SELECT P.PROD_ID, P.PROD_COD,P.PROD_NOME,P.PROD_VALOR, P.PROD_VALOR_VENDA, P.PROD_QTD, P.PROD_QTD_MIN, P.PROD_MARCA FROM  TBL_PRODUTO AS P
 WHERE P.PROD_MARCA ='NATURA' ORDER BY PROD_NOME ASC
