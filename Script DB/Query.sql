...
UPDATE TBL_FORNECEDOR SET FOR_NOME_FANT = '', FOR_CNPJ = '' WHERE FOR_ID = 
UPDATE TBL_TELEFONE SET TEL_FIXO = '', TEL_CELULAR = '', TEL_DDD = '', TEL_OPERADORA = ''  WHERE TEL_ID = ''
UPDATE TBL_ENDERECO SET END_BAIRRO = @BAIRRO, END_RUA = @RUA, END_NUMERO = @NUM, END_CEP = @CEP, END_COMP = @COMP WHERE END_ID = @ID
 
UPDATE TBL_FORNECEDOR SET TEL_ID = '' WHERE FOR_ID =



SELECT F.FOR_ID, F.FOR_NOME_FANT,F.FOR_CNPJ, T.TEL_CELULAR, T.TEL_FIXO,T.TEL_DDD,T.TEL_OPERADORA,E.END_BAIRRO, E.END_RUA,E.END_NUMERO, E.END_CEP, 
...
INNER JOIN TBL_ENDERECO AS E ON E.END_ID= FE.END_ID WHERE F.FOR_ID = 2
