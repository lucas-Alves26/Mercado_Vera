...
INSERT INTO TBL_FORNECEDOR(FOR_NOME,FOR_CNPJ,FOR_NOME_FANT,FOR_EMAIL,FOR_DESC)
VALUES('MATIAS CAMPOS','22365984523622','EXTRA','EXTRA@hotmail.com','Mercado')

INSERT INTO TBL_FORNECEDOR(FOR_NOME,FOR_CNPJ,FOR_NOME_FANT,FOR_EMAIL,FOR_DESC)
VALUES('MARIO SUZANO','32365984523333','IMPORTADOS LTDA','importltda@hotmail.com','Loja de importados')

INSERT INTO TBL_FORNECEDOR(FOR_NOME,FOR_CNPJ,FOR_NOME_FANT,FOR_EMAIL,FOR_DESC,TEL_ID)
VALUES('LUIZA MARTINS SILVA','12365984523657','NATURA','natura@hotmail.com','Loja de cósmeticos',1)

SELECT * FROM TBL_FORNECEDO

INSERT INTO TBL_PROD_FORN(PROD_ID, FOR_ID)VALUES(2,2)
INSERT INTO TBL_PROD_FORN(PROD_ID, FOR_ID)VALUES(3,3)
INSERT INTO TBL_PROD_FORN(PROD_ID, FOR_ID)VALUES(4,4)
