...
CREATE TABLE TBL_PRODUTO(
  PROD_COD INT NOT NULL IDENTITY(1,1),
  SUB_CAT_ID INT,
  FOT_ID INT,
...
--PRIMARY KEY
ALTER TABLE TBL_PRODUTO ADD CONSTRAINT PK_PRODUTO_ID PRIMARY KEY (PROD_COD)
--FOREIGN KEY
...
CREATE TABLE TBL_FORNECEDOR (
  ...
  TEL_ID INT NOT NULL,
  FOR_NOME VARCHAR(50),
  FOR_NOME_FANT VARCHAR(50) NOT NULL,
  FOR_CNPJ VARCHAR(14) NULL,
  FOR_EMAIL VARCHAR(100) NULL,
  FOR_DESC VARCHAR(100) NULL
)
---PRIMARY KEY
...
---FOREIGN KEY
ALTER TABLE TBL_VENDA
ADD CONSTRAINT FK_VEN_PROD_ID FOREIGN KEY (PROD_COD) REFERENCES TBL_PRODUTO
