...
IF EXISTS (SELECT name FROM master.sys.databases WHERE name = N'MERCADO_01')
...
CREATE TABLE TBL_TELEFONE (
  ...
  TEL_FIXO VARCHAR(14),
  TEL_OPERADORA VARCHAR(15),
 -- TEL_STATUS VARCHAR(15)NOT NULL
)
GO
--PRIMARY KEY
...
GO
--ALTER TABLE TBL_CLIENTE ADD CONSTRAINT UK_RG UNIQUE(CLI_RG)
--GO
--ALTER TABLE TBL_CLIENTE ADD CONSTRAINT UK_CPF UNIQUE(CLI_CPF)
--GO
